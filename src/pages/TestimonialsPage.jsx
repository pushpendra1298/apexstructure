...
const testimonials = [
  ...
  { client: 'Rohit Agarwal', role: 'CEO, Kolkata', feedback: 'Their structural expertise and execution strategy helped us optimize both cost and timeline efficiently. The IRTT risk tracking dashboard gave us real-time visibility at every stage.' },
  { client: 'Neha Kapoor', role: 'Director, Gurgaon', feedback: 'Professional, responsive, and highly skilled. Apex Structure ensured smooth coordination across all project stages. From MEP design to final handover, everything was handled with precision.' },
  { client: 'Suresh Reddy', role: 'Founder, Hyderabad', feedback: 'Outstanding attention to detail and on-site supervision. The team maintained quality standards at every step. Their pre-engineered building design saved us significant cost and time.' },
  { client: 'Vikram Singh', role: 'Managing Director, Jaipur', feedback: 'Apex Structure exceeded our expectations with their RCC culvert and bridge design. The documentation was thorough and the structural calculations were precise, giving us full confidence in the project.' },
  ...
  { client: 'Arjun Nair', role: 'Project Director, Kochi', feedback: 'A world-class engineering firm with strong local expertise. Their STP and water tank design for our residential complex was flawless and passed all regulatory checks on the first submission.' },
]
